...
var ScaleX, ScaleY, Count, Co : integer;
    PDC : HDC;
  ...
  begin
    ...
    if (SW.Controls[Co] is TCustomComboBox) or
     ((not(SW.Controls[Co] is TCustomLabel)) and (MC.BorderStyle = bsSingle)) or
     ((not(SW.Controls[Co] is TCustomStaticText)) and (MC.BorderStyle = bsSingle))
      then begin
    ...
    if (SW.Controls[Co] is TCustomLabel) or
       (SW.Controls[Co] is TCustomMemo) then
    begin
...
begin  {PrintPage}
  ...
  try
    ...
    begin
      ...
      Printer.Canvas.Brush.Style := bsClear;
      if (SW.Controls[Co] is TLabel) or
         (SW.Controls[Co] is TCustomStaticText) or
